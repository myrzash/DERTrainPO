...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__games_Step_vue__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__games_Step_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__games_Step_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__games_Pair_vue__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__games_Pair_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__games_Pair_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__games_Test_vue__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__games_Test_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__games_Test_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__games_Selectable_vue__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__games_Selectable_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__games_Selectable_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        Lecture: __WEBPACK_IMPORTED_MODULE_0__games_Lect_vue___default.a, Test: __WEBPACK_IMPORTED_MODULE_3__games_Test_vue___default.a, Pair: __WEBPACK_IMPORTED_MODULE_2__games_Pair_vue___default.a, Step: __WEBPACK_IMPORTED_MODULE_1__games_Step_vue___default.a, Selectable: __WEBPACK_IMPORTED_MODULE_4__games_Selectable_vue___default.a
    },
    methods: {
    ...
    computed: {
        ...
        nextPart: function nextPart() {
            ...
            var end = nextGameId < this.$lang.value.parts.length;
            if (!end) return null;
            return {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Sections_vue__ = __webpack_require__(47);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        clickBtnExcess: function clickBtnExcess(item) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        clickPlay: function clickPlay(index) {
            this.played.forEach(function (item) {
        ...
        clickPause: function clickPause(index) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__FindToMatch_vue__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__FindToMatch_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__FindToMatch_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['items'],
    components: {
        FindToMatch: __WEBPACK_IMPORTED_MODULE_0__FindToMatch_vue___default.a
    },
    data: function data() {
        return {
            attempt: 0,
    ...
    created: function created() {
        ...
        this.$on('setResult', function (resultKey) {
            console.log("setResult Pair: ", resultKey);
            _this.correctExcesses.push(resultKey);
            _this.gameOver();
        });
        this.items.pairs.forEach(function (item, index) {
            _this.pairs.push({ key: index, data: item[0] });
            _this.pairs.push({ key: index, data: item[1] });
        });
        this.$parent.shuffle(this.pairs);
        this.progress = 0;
    },
    beforeDestroy: function beforeDestroy() {
        this.pair = [];
    ...
    methods: {
        getResultPair: function getResultPair() {
            if (this.progress == this.pairs.length / 2) {
                var result = 2 * (this.progress + this.bonus) / this.attempt * 100;
                result = result > 100 ? 100 : result;
                result = result < 0 ? 0 : result;
                console.log("getResultPair: ", result);
                return result;
            }
            return -1;
        },
        getResultMatch: function getResultMatch() {
            var max = this.items.excesses.data.length;
            if (this.correctExcesses.length == max) {
                var countCorrect = this.correctExcesses.filter(function (item) {
                    return item == true;
                }).length;
                var result = countCorrect / max * 100;
                result = result > 100 ? 100 : result;
                result = result < 0 ? 0 : result;
        ...
        gameOver: function gameOver() {
            if (this.getResultPair() >= 0 && this.getResultMatch() >= 0) {
                var result = this.getResultPair() * 0.7 + this.getResultMatch() * 0.3;
        ...
        clickPair: function clickPair(item) {
            var _this2 = this;
            ...
            if (pair.includes(item)) {
                pair.splice(pair.indexOf(item), 1);
                this.attempt -= 2;
            } else {
                pair.push(item);
            }
            ...
            if (pair.length == 2) {
                ...
                setTimeout(function () {
                    if (_this2.correct) {
                        var index1 = _this2.pairs.indexOf(pair[0]);
                        _this2.pairs[index1].disabled = true;
                        var index2 = _this2.pairs.indexOf(pair[1]);
                        _this2.pairs[index2].disabled = true;
                    }
                    ...
                    console.log("this.progress: ", _this2.progress);
                    console.log("this.pairs: ", _this2.pairs.length / 2);
                    console.log("attempt: ", _this2.attempt);
                    _this2.gameOver();
                }, 500);
            }
        }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DialogSelectable_vue__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DialogSelectable_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__DialogSelectable_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        this.attempt = 0;
        this.correct = 0;
        this.$on('setResult', function (item) {
            _this.attempt++;
            if (item.isTrue) _this.correct++;

            setTimeout(function () {
                if (_this.maxProgress == _this.correct) {
                    _this.$router.push({
                        name: 'res',
                        params: { result: _this.correct / _this.attempt * 100, resId: _this.$route.params.gameId }
                    });
                }
            }, 800);
        });
    ...
    components: {
        DialogSelectable: __WEBPACK_IMPORTED_MODULE_0__DialogSelectable_vue___default.a
    },
    computed: {
        programs: function programs() {
            var array = new Array();
            this.items.parts.forEach(function (part, index) {
                for (var id in part.tiles) {
                    var programs = part.tiles[id].programs;
        ...
        maxProgress: function maxProgress() {
            var count = 0;
            this.items.parts.forEach(function (part) {
                var _iteratorNormalCompletion = true;
                var _didIteratorError = false;
                var _iteratorError = undefined;

                try {
                    for (var _iterator = part.tiles[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        var item = _step.value;
                        var programs = item.programs;

                        if (programs) count += programs.length;
                    }
                } catch (err) {
                    _didIteratorError = true;
                    _iteratorError = err;
    ...
    methods: {
        ...
        getVariants: function getVariants(partId, tileId, program) {
            var variants = new Array();
            variants.push({ isTrue: true, image: program });
            var shuffle = this.programs.slice();
            ...
            try {
                outer: for (var _iterator2 = shuffle[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Lang_vue__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_vue_scroll__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_vue_scroll___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_vue_scroll__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__store__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_Main_vue__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_Game_vue__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_Game_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__components_Game_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_DialogResult_vue__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_DialogResult_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10__components_DialogResult_vue__);
...
__WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_4_vuejs_localization___default.a);
__WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_6_vue_scroll___default.a);

var router = new __WEBPACK_IMPORTED_MODULE_2_vue_router__["a" /* default */]({
    routes: [{
        path: '/:lang', component: __WEBPACK_IMPORTED_MODULE_5__Lang_vue___default.a,
        children: [{ path: '', name: 'main', component: __WEBPACK_IMPORTED_MODULE_8__components_Main_vue___default.a }, {
            path: 'game/:gameId', name: 'game', component: __WEBPACK_IMPORTED_MODULE_9__components_Game_vue___default.a
            // children: [
            //
            // ]
            // children: [
            ...
            // ]
        }, { path: 'res', name: 'res', component: __WEBPACK_IMPORTED_MODULE_10__components_DialogResult_vue___default.a }]
    }]
});
...
// module
exports.push([module.i, ".mflex{display:flex;flex-direction:row;justify-content:center;align-items:center}.partimage{background-repeat:no-repeat!important;background-position:top;background-size:cover!important;min-height:150px}.container-video{position:relative}.container-video img{position:absolute;left:0;top:0;width:100%;height:100%;background:no-repeat 50% cover!important}.btnPause,.btnPlay{left:50%;top:50%;margin-left:-28px;margin-top:-28px}.btnPause{opacity:0}.btnPause:hover{opacity:1}.btnText{min-height:60px;font-size:1.2em;height:auto!important;text-transform:none}.btnText>.btn__content{white-space:inherit!important;line-height:1.5em;flex:auto}", ""]);
...
// module
exports.push([module.i, ".prolog ul li{margin:16px;padding:16px;list-style:none;background:#2196f3;font-weight:bolder;color:#fff;cursor:pointer}", ""]);
...
// module
exports.push([module.i, ".rememberList ul li{margin:16px;padding:16px;list-style:none;background:#2196f3;font-weight:bolder;color:#fff;cursor:pointer}.bgImage{background-color:transparent;background-repeat:no-repeat;background-size:cover;min-height:800px;background-position:top}", ""]);
...
// module
exports.push([module.i, ".btnImage{min-width:260px;min-height:240px;overflow:hidden}.btnText{font-size:1.6em}.image{background-position:50%;background-repeat:no-repeat;background-size:contain;position:absolute;width:94%;height:94%;left:3%;top:3%;transition:transform .3s}", ""]);
...
// module
exports.push([module.i, ".btn-select-image{width:100%;height:240px;max-height:240px;max-width:240px;background-repeat:no-repeat;background-position:50%;background-size:200px auto}", ""]);
...
// module
exports.push([module.i, "#app{font-family:AppFont;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}.bolder{font-family:AppFont900}.btn{font-weight:900!important}", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('h3', [_vm._v(_vm._s(_vm.items.title))])]), _vm._v(" "), _vm._l((_vm.items.parts), function(part, partId) {
    return _c('v-flex', {
      staticClass: "mb-5",
      attrs: {
        "xs12": "",
      ...
      staticClass: "bolder mb-5"
    }, [_vm._v(" " + _vm._s(part.title))]), _vm._v(" "), _vm._l((part.tiles), function(tile, index) {
      return _c('div', {
        staticClass: "mt-5"
      }, [_c('h4', [_vm._v(_vm._s(tile.title))]), _vm._v(" "), _c('div', {
        staticStyle: {
          "display": "flex",
          "flex-direction": "row",
      ...
      }, _vm._l((tile.programs), function(program) {
        return _c('dialog-selectable', {
          staticClass: "mr-2 ml-2",
          attrs: {
            "id": partId + '' + index,
            "items": _vm.getVariants(partId, index, program)
          }
        })
      }))])
    })], 2)
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('v-layout', {
    ...
    staticClass: "bolder"
  }, [_vm._v(_vm._s(_vm.items.excesses.title))])]), _vm._v(" "), _vm._l((_vm.items.excesses.data), function(excess) {
    return _c('v-flex', {
      staticClass: "pa-4",
      attrs: {
        "xs12": "",
    ...
    staticClass: "bolder"
  }, [_vm._v(_vm._s(_vm.items.title))])]), _vm._v(" "), _c('v-flex', {
    staticClass: "pa-4",
    attrs: {
      "xs12": "",
      "md10": "",
  ...
  }, _vm._l((_vm.pairs), function(item) {
    return _c('v-btn', {
      staticClass: "btnText",
      attrs: {
        "large": "",
        "success": _vm.correct && _vm.pair.includes(item),
        "error": _vm.wrong && _vm.pair.includes(item),
        "disabled": item.disabled,
        "primary": _vm.pair.includes(item)
      },
      nativeOn: {
  ...
  }, _vm._l((_vm.items.winWord.split('')), function(letter, index) {
    return _c('v-card', {
    ...
    }, [(index < _vm.progress) ? _c('v-card', {
      staticClass: "pl-2 pr-2 bolder accent white--text"
    }, [_c('v-card-text', {
      staticClass: "headline"
    }, [_vm._v(_vm._s(letter))])], 1) : _vm._e()], 1), _vm._v(" "), (index >= _vm.progress) ? _c('v-card', {
      staticClass: "pl-2 pr-2 btn--disabled transparent--text"
    }, [_c('v-card-text', {
      staticClass: "headline"
    }, [_vm._v(_vm._s(letter))])], 1) : _vm._e()], 1)
  }))], 1)], 2)], 1)
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c(_vm.part.interactive.name, {
  ...
  }), _vm._v(" "), _c('router-view'), _vm._v(" "), (_vm.nextPart) ? _c('v-layout', {
    staticClass: "black pa-5",
    attrs: {
      "text-xs-right": "",
      "row": "",
      "wrap": ""
    ...
    staticClass: "headline white--text pa-2 mt-2 mr-5 ml-5"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [(_vm.excesses) ? _c('v-layout', {
    attrs: {
      "row": "",
      "justify-center": "",
      "wrap": "",
  ...
  }, [_vm._l((_vm.excesses), function(item) {
    return _c('v-flex', {
      attrs: {
        "xs12": "",
        "md2": ""
      ...
      attrs: {
        "large": "",
        "primary": item == _vm.selected,
        "disabled": _vm.checked && item != _vm.selected,
        "error": item == _vm.selected && _vm.checked == true,
        "success": item == _vm.selected && item.isTrue && _vm.checked == true
      },
      nativeOn: {
        "click": function($event) {
          _vm.clickBtnExcess(item)
        }
      }
    }, [_vm._v("\n                " + _vm._s(item.data) + "\n                ")])], 1)
  }), _vm._v(" "), _c('v-flex', {
    ...
    attrs: {
      "disabled": !_vm.selected || _vm.checked,
      "large": "",
      "primary": ""
    },
    nativeOn: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('v-layout', {
  ...
  }, [(_vm.items.prolog) ? _c('h5', {
    staticClass: "prolog",
    domProps: {
      "innerHTML": _vm._s(_vm.items.prolog)
    }
  ...
  }, [_vm._l((_vm.items.steps), function(item, index) {
    return (_vm.items) ? [_c('v-stepper-step', {
      attrs: {
        "step": index + 1,
        "complete": _vm.position > index
      },
      nativeOn: {
        "click": function($event) {
          _vm.position = index + 1
        }
      }
    }), _vm._v(" "), _c('v-stepper-content', {
      attrs: {
        "step": index + 1
      }
    }, [_c('v-layout', {
      ...
      staticClass: "pa-4",
      class: [item.image ? 'md8' : ''],
      attrs: {
        "xs12": ""
      }
    }, [(item.title) ? _c('h3', {
      staticClass: "bolder mb-5"
    }, [_vm._v(_vm._s(item.title))]) : _vm._e(), _vm._v(" "), (item.header) ? _c('h5', {
      staticClass: "mb-5",
      domProps: {
        "innerHTML": _vm._s(item.header)
      }
    }) : _vm._e(), _vm._v(" "), (item.text) ? _c('h5', {
      staticClass: "mb-5",
      domProps: {
      ...
      attrs: {
        "href": item.href.link,
        "download": item.href.download ? item.href.download : false
      }
    }, [_vm._v(_vm._s(item.href.title) + "\n                                ")]) : _vm._e()]), _vm._v(" "), (item.footer) ? _c('h5', {
      staticClass: "mb-5",
      domProps: {
        "innerHTML": _vm._s(item.footer)
      }
    }) : _vm._e()])], 1), _vm._v(" "), (item.video) ? _c('div', {
      staticClass: "container-video"
    }, [_c('div', {
      directives: [{
        name: "show",
        rawName: "v-show",
        value: (!_vm.played.includes(index)),
        expression: "!played.includes(index)"
      }],
      staticStyle: {
        "position": "absolute",
        "background": "black",
      ...
      attrs: {
        ...
        "frameborder": "0",
        "id": 'vid' + index,
        "controls": _vm.played.includes(index)
      }
    ...
    }, [_vm._v("pause")])], 1)], 1), _vm._v(" "), _c('v-fab-transition', [_c('v-btn', {
      directives: [{
        name: "show",
        rawName: "v-show",
        value: (!_vm.played.includes(index)),
    ...
    }, [_vm._v("play_arrow\n                                    ")])], 1)], 1)], 1) : _vm._e(), _vm._v(" "), (index < _vm.items.steps.length - 1) ? _c('v-btn', {
      staticStyle: {
        "width": "100%"
      },
      attrs: {
      ...
      staticClass: "ml-1"
    }, [_vm._v("navigate_next")])], 1) : _vm._e()], 1)] : _vm._e()
  })], 2)], 1)], 1)], 1)
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [(_vm.items.images) ? _c('v-layout', {
    staticClass: "white",
    attrs: {
      "column": "",
      "text-xs-center": ""
  ...
  }, _vm._l((_vm.items.images), function(item, index) {
    return _c('v-card', {
      staticClass: "mt-4 mb-4",
      attrs: {
        "flat": ""
      }
    }, [_c('h4', [_vm._v(_vm._s(item.title))]), _vm._v(" "), _c('v-layout', {
      attrs: {
        "align-center": "",
        "row": "",
        "wrap": ""
      ...
      attrs: {
        "src": item.src,
        "height": (item.heightImage) ? item.heightImage : '100%',
        "alt": ""
      }
    }) : _vm._e()]), _vm._v(" "), _c('v-flex', {
      attrs: {
      ...
      staticClass: "pa-2 ml-4 text-xs-justify",
      domProps: {
        "textContent": _vm._s(item.text)
      }
    })])], 1), _vm._v(" "), (index != _vm.items.images.length - 1) ? _c('v-divider', {
      staticClass: "mt-4"
    }) : _vm._e()], 1)
  }))], 1) : _vm._e(), _vm._v(" "), _vm._l((_vm.items.videos), function(item, index) {
    return _c('div', {
      staticClass: "bgImage",
      style: ({
        'background-image': item.parallax ? ("url('" + (item.parallax.src) + "')") : ''
      })
    }, [_c('v-layout', {
      attrs: {
        "column": ""
      ...
      staticClass: "mt-4 mb-4 transparent",
      attrs: {
        "flat": ""
      }
    }, [_c('h4', [_vm._v(_vm._s(item.title))]), _vm._v(" "), (item.header) ? _c('h5', {
      staticClass: "pa-4 bolder",
      domProps: {
        "innerHTML": _vm._s(item.header)
      }
    }) : _vm._e(), _vm._v(" "), (item.src) ? _c('div', {
      staticClass: "container-video"
    }, [_c('video', {
      attrs: {
        "src": item.src,
    ...
    }, [_vm._v("play_arrow\n                                ")])], 1)], 1)], 1) : _vm._e(), _vm._v(" "), _c('h5', {
      staticClass: "pa-4",
      domProps: {
        "innerHTML": _vm._s(item.text)
      }
    })])], 1)], 1)], 1)
  }), _vm._v(" "), (_vm.items.remember) ? _c('v-layout', {
    staticClass: "grey lighten-3",
    attrs: {
      "column": ""
    }
    ...
    staticClass: "mt-4 mb-4"
  }, [_vm._v(_vm._s(_vm.$lang.string.remember))]), _vm._v(" "), _vm._l((_vm.items.remember), function(item, index) {
    return _c('div', {
      staticClass: "mt-4 mb-4"
    }, [_c('p', {
      staticClass: "headline rememberList",
      domProps: {
        "innerHTML": _vm._s(item.text)
      }
    })])
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('v-layout', {
    ...
    return _c('div', [_c('v-slide-x-transition', [_c('maincard', {
      staticClass: "ma-2",
      attrs: {
        "part": part,
        "id": id
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('v-slide-x-transition', [_c('div', [_c('v-layout', {
    attrs: {
      "column": ""
    }
  }, [_c('v-flex', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('v-layout', {
  ...
  }, [_vm._v(_vm._s(_vm.$lang.value.grade))])])])]), _vm._v(" "), _c('transition', {
    attrs: {
      "name": "fade"
    }
  }, [_c('div', {
    ...
    staticClass: "ma-5 bolder",
    staticStyle: {
      "max-width": "800px"
    }
  }, [_vm._v(_vm._s(_vm.$lang.value.title))]), _vm._v(" "), _c('h2', {
    staticClass: "ma-5"
  }, [_vm._v(_vm._s(_vm.$lang.value.typeder))])])]), _vm._v(" "), _c('transition', {
    attrs: {
      "name": "fadeUp"
    }
  }, [_c('v-layout', {
  ...
  }, [_vm._v("— " + _vm._s(_vm.$lang.value.prologue.author))])])], 1)], 1)], 1)], 1)], 1), _vm._v(" "), _c('v-flex', {
    attrs: {
      "lg5": "",
      "hidden-md-and-down": ""
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('v-layout', {
    ...
    style: ({
      backgroundImage: _vm.current ? ("url('" + (_vm.current.image) + "')") : ''
    }),
    attrs: {
      "disabled": _vm.current && _vm.current.isTrue,
      "primary": "",
      "round": "",
      "dark": ""
    },
    slot: "activator"
  }, [(!_vm.current) ? _c('v-icon', {
    attrs: {
      "x-large": ""
    }
  }, [_vm._v("touch_app")]) : _vm._e()], 1), _vm._v(" "), _c('v-card', [_c('h5', {
    staticClass: "primary--text text-xs-center pa-3 bolder"
  }, [_vm._v("\n                " + _vm._s(_vm.$lang.string.choiceOneVariant) + "\n            ")]), _vm._v(" "), _c('v-layout', {
    staticClass: "pr-3",
    attrs: {
      "row": "",
      "wrap": "",
    ...
    return _c('v-flex', {
      ...
      staticClass: "btn-select-image elevation-8",
      style: ({
  ...
  }))], 1)], 1), _vm._v(" "), (_vm.current) ? _c('div', {
    staticStyle: {
      "position": "absolute",
      "top": "100%"
    }
  }, [(_vm.current.isTrue) ? _c('v-icon', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('v-app', {
    ...
    attrs: {
      "href": "http://der.nis.edu.kz/feedback2/index.html?id=inf20174",
      "target": "_blank",
      "icon": ""
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    staticClass: "blue white--text pa-4 bodyCard",
    style: ({
    ...
    staticClass: "headline"
  }, [_vm._v("\n                    " + _vm._s(_vm.part.info) + "\n                ")]) : _vm._e()])], 1)]), _vm._v(" "), _c('v-progress-linear', {
    attrs: {
      "info": _vm.$store.getters.result(_vm.id) != 100,
      "success": _vm.$store.getters.result(_vm.id) == 100,
      "value": _vm.$store.getters.result(_vm.id)
    }
  }), _vm._v(" "), _c('h6', {
    staticClass: "text-xs-right",
    class: [_vm.$store.getters.result(_vm.id) == 100 ? 'green--text' : 'blue--text']
  }, [_c('strong', [_vm._v(_vm._s(_vm.$store.getters.result(_vm.id)) + "%")])])], 1)
},staticRenderFns: []}
...
var update = __webpack_require__(2)("20509fb4", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("1216a415", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("563f9cc4", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("13fa9761", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("4e48a613", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("41e24b8d", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("b3bc6c7e", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("33aa2bdc", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("577e01ec", content, true);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("7034864c", content, true);
